...
var blockUnblock = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var updated, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, models_1.User.updateOne({ _id: data._id }, { isBlocked: data.isBlocked })];
            case 1:
                updated = _a.sent();
                if (!updated) {
