...
var createCourseController = function (Dependencies) {
    var createCourseUseCase = Dependencies.useCases.createCourseUseCase;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, createCourseUseCase(Dependencies).execute(req.body)];
                case 1:
                    category = _a.sent();
                    if (category) {
