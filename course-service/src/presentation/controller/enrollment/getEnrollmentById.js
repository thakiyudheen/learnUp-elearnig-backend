...
var getEnrollmentByIdController = function (Dependencies) {
    var getEnrollmentByIdUseCase = Dependencies.useCases.getEnrollmentByIdUseCase;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getEnrollmentByIdUseCase(Dependencies).execute(data)];
                case 1:
                    enrollment = _a.sent();
