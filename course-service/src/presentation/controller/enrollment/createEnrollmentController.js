...
var createEnrollmentController = function (Dependencies) {
    var createEnrollmentUseCase = Dependencies.useCases.createEnrollmentUseCase;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, createEnrollmentUseCase(Dependencies).execute(req.body)];
                case 1:
                    enrollment = _a.sent();
                    if (!enrollment) {
