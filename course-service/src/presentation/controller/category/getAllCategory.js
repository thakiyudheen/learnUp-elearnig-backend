...
var getAllCategoryController = function (Dependencies) {
    var getAllCategoryUseCase = Dependencies.useCases.getAllCategoryUseCase;
    return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, getAllCategoryUseCase(Dependencies).execute(req.query)];
                case 1:
                    category = _a.sent();
                    if (category) {
